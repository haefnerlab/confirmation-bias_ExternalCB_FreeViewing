function [params_boot,sobl,abbl,best_hprs,data,accuracy,num_image,mean_oval_signal1,acc_evi_all,pro_choice_all,...
    ...
    = analysis_compute_all_kernels(subjectID, expt_type, boot_n, hpr1, hpr2, split_parameter, bin, choose_abs_PK, learn_num_PK)
% initialize
...
[best_hprs, ~] = xValidatePK_with_lapse(mean_oval_signal1, choice1, split_parameter, num_image, hpr1, 0, hpr2, 0, 10,learn_num_PK);
