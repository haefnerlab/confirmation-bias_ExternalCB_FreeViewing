function [best_hprs, log_likelihoods] = xValidatePK_with_lapse_spotlight(data, responses, frames, hpr_ridge, hpr_ar1, hpr_curvature, standardize, folds)
...
%         hpr_ridge(iRidge), hpr_ar1(iAR1), hpr_curvature(iCurve), 0);
    [params, ~, ~, ~, ~, ~] = ...
    CustomRegression.PsychophysicalKernelwithlapse_spotlight(data(dataIdx, :), responses(dataIdx), frames,  ...
        hpr_ridge(iRidge), hpr_ar1(iAR1), hpr_curvature(iCurve), 0);
...
% logits = data * params(1:end-1) + params(end);
