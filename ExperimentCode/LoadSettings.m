...
%if ~isfield(settings, 'screenSize'), settings.screenSize = [0 0 trueSize.width trueSize.height]/2; end
...
if ~isfield(settings, 'monitorDistInches'), settings.monitorDistInches = 43; end
if ~isfield(settings, 'monitorSizeInches'), settings.monitorSizeInches = [21 13.38];end
